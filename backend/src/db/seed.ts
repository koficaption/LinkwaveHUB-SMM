...
export async function seed() {
  ...
  await query(
    `INSERT INTO payment_methods (code, name, description, adapter, is_enabled, sort_order, config) VALUES
     ...
     ('korapay', 'Korapay (automatic)', 'Pay instantly with Mobile Money in Ghana, cards/bank in Nigeria, and other Korapay countries. Wallet is credited in GHS after Korapay confirms.', 'korapay', $2, 1, $3::jsonb)`,
  ...
  await query(
    `INSERT INTO settings (key, value) VALUES
     ...
     ('payments', '{"autoApproveMock":true,"korapayCustomerPaysFees":true,"korapayFeePercent":1.5,"korapayVatPercent":15}'),
