...
export const config = {
  ...
  recaptchaSiteKey: process.env.RECAPTCHA_SITE_KEY || process.env.RECAPTCHA_SITEKEY || "",
  recaptchaSecretKey: process.env.RECAPTCHA_SECRET_KEY || process.env.RECAPTCHA_SECRET || "",
