import {
  AtSign, Bell, Bookmark, Clock, Eye, Facebook, Heart, Instagram, MessageCircle, Music, Music2,
...
const map: Record<string, LucideIcon> = {
  ...
  MessageCircle, Share2, Bell, Clock, Bookmark, Smile, UserPlus, Globe, AtSign,
};
